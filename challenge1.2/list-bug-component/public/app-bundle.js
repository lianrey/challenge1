...
var _ListBugs = __webpack_require__(29);

var _ListBugs2 = _interopRequireDefault(_ListBugs);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var data = document.__INITIALSTATE__;
(0, _reactDom.render)(_react2.default.createElement(_ListBugs2.default, { bugs: data }), document.getElementById("root"));
...
var ListBugs = function (_BaseComponent) {
  _inherits(ListBugs, _BaseComponent);

  function ListBugs(props) {
    _classCallCheck(this, ListBugs);

    var _this = _possibleConstructorReturn(this, (ListBugs.__proto__ || Object.getPrototypeOf(ListBugs)).call(this, props));
  ...
  _createClass(ListBugs, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var newState = { bugs: document.__INITIALSTATE__ };
    ...
    value: function render() {
      var body = this.state.bugs.map(function (b) {
