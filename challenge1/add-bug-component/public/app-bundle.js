...
var _AddBug = __webpack_require__(29);

var _AddBug2 = _interopRequireDefault(_AddBug);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_AddBug2.default, null), document.getElementById("root"));
...
var _BaseComponent2 = __webpack_require__(30);
...
var AddBug = function (_BaseComponent) {
  _inherits(AddBug, _BaseComponent);

  function AddBug(props) {
    _classCallCheck(this, AddBug);

    var _this = _possibleConstructorReturn(this, (AddBug.__proto__ || Object.getPrototypeOf(AddBug)).call(this, props));

    var data = {};

    _this.bind(['handleSubmit', 'onFieldhanged']);
  ...
  _createClass(AddBug, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      this.updateData('id', (0, _uuid2.default)());
      console.log(this.state.data);
      var formData = JSON.stringify(this.state.data);
      document.getElementById("list").value = formData;
    }
  }, {
    key: 'onFieldhanged',
    value: function onFieldhanged(e) {
      this.updateData(e.currentTarget.attributes['name'].value, e.currentTarget.value);
    }
  }, {
    key: 'updateData',
    value: function updateData(indexName, value) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'select',
            { id: 'status', name: 'status', onChange: this.onFieldhanged, required: true },
            _react2.default.createElement(
              'option',
              { value: '' },
              'Select'
          ...
          _react2.default.createElement(
            'select',
            { id: 'priority', name: 'priority', onChange: this.onFieldhanged, required: true },
            _react2.default.createElement(
              'option',
              { value: '' },
              'Select'
          ...
          _react2.default.createElement('input', { id: 'owner', type: 'text', value: this.state.data["Owner"], name: 'owner',
            onChange: this.onFieldhanged, placeholder: 'Owner', required: true }),
          _react2.default.createElement('br', null),
          _react2.default.createElement(
            'label',
            { htmlFor: 'description' },
          ...
          _react2.default.createElement('input', { id: 'description', type: 'text', value: this.state.data["Description"], name: 'description',
            onChange: this.onFieldhanged, placeholder: 'Description', required: true }),
          _react2.default.createElement('br', null),
          _react2.default.createElement(
            'button',
            { type: 'submit' },
...
var BaseComponent = function (_React$Component) {
  ...
  _createClass(BaseComponent, [{
    ...
    value: function bind(method) {
      ...
      if (typeof method === 'string') {
        ...
        method.map(function (method) {
          ...
          return _this2[method];
        });
      }
      return this[method];
    }
  }, {
    key: 'find_with_key_and_value',
    value: function find_with_key_and_value(array, key, value) {
    ...
    key: 'find_with_key',
    value: function find_with_key(array, key) {
      return array[0][key];
    }
  }, {
    key: 'generateUIKey',
    value: function generateUIKey() {
      var prependValue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'key';

      function s4() {
        return Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
      }
      return prependValue + s4() + s4() + '-' + s4() + '-' + s4() + '-' + s4() + '-' + s4() + s4() + s4();
    }
  }, {
    key: 'stripHTMLtags',
    ...
    value: function truncate(str, max) {
      if (str.length === 0 && str.constructor === Object) return '';

      return str.length > max ? str.replace(/^(.{205}[^\s]*).*/, "$1") + '... ' : str;
    }
  }, {
    key: 'dedupeByKey',
    value: function dedupeByKey(arr, key) {
      var temp = arr.map(function (el) {
        return el[key];
      });
      return arr.filter(function (el, i) {
        return temp.indexOf(el[key]) === i;
      });
    }
  }, {
    key: 'isEmpty',
